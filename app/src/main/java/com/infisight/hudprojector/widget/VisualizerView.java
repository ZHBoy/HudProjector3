...
public class VisualizerView extends View {
	...
	private int mSpectrumNum = 25;// 取样数
	private int Padding = 10;// 左右边距
	...
	private float mLevelLine = 100;// 水位线
	private float mWaveHeight = 100;// 波浪起伏幅度
	private float mWaveWidth = 20;// 波长
	...
	private void init() {
		...
		mPaint.setColor(Color.parseColor("#4876FF"));
